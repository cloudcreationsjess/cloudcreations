set :stage, :staging
set :deploy_to, -> { "/home/u1140-q2nxlfcuckwc/www/cloudcreations.ca" }
set :tmp_dir, "/home/u1140-q2nxlfcuckwc/www/cloudcreations.ca/tmp"
set :keep_releases, 2
...
# ======================
server 'cloudcreations.ca', user: 'u1140-q2nxlfcuckwc', port: 18765, password: 'ssh.C!0ud', roles: %w{web app db}
...
SSHKit.config.command_map[:composer] = "/usr/bin/php /home/u1140-q2nxlfcuckwc/composer.phar"
